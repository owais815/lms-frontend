...
export const ProfileComponentGeneric = () => {
    const background = "../../src/images/dummyupcoming";
    return (
        <main className="profile-page">
        <section className="relative block h-500-px">
          <div style={{backgroundImage:`url(${background})`}} className=" w-full h-full bg-center bg-cover ">
